...
def play_song_thread(player, instance, url):
    ...
    def play_song(self,query):
        ...
        t = threading.Thread(target=play_song_thread, args=(player, instance, playurl))
        t.start()
    ...
    def process(self,query):
        ...
        if 'open youtube' in query:
            ...
            self.getDefinition(query)

        elif 'calculate' in query:
            self.getWolframAlpha(query)
