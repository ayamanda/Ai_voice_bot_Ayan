...
class backend:
    ...
    def getWolframAlpha(query,speak):
    ...
    def exitCommand(query,speak,myCommand):
        query = query.lower()
    ...
    def get_gpt_response(query,speak):
